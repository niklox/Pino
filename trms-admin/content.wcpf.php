...
function editContent($cid, $nid){
	...
	if( $content->getTemplateID() == 37 || $content->getTemplateID() == 38 || $content->getTemplateID() == 49 || $content->getTemplateID() == 52 || $content->getTemplateID() == 53){
	...
	if( $content = ContentGetByID($cid) ) {
		...
		*/
		...
		if(	$content->getTemplateID() == 10 || 
			...
			$content->getTemplateID() == 52 ||
			$content->getTemplateID() == 53
			)
