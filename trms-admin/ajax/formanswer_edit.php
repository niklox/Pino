...
function viewQuizAnswer($formanswerid){
	...
	print	"<tr><td></td><td>Correct:</td><td>".$correctanswers."</td></tr>";
	print	"<tr><td class=\"left80\"><input type=\"button\" class=\"deleteanswer\" id=\"deleteanswer_".$formanswer->getID()."\" value=\"Delete this answer\"/></td><td class=\"right20\"></td><td></td></tr>";
	print	"</table>";
}
