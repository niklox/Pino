$(function(){
	...
	$("#globalvote_as_excel").live('click', function(){
		window.location.href = "/trms-admin/globalvote_excel.php?fid=" + $("#fid").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&countryid=" + $("#countryid option:selected").val() + "&votetype=" + $("#votetype option:selected").val();
	});
