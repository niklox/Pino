...
function defaultAction(){
	...
	while($comments = DiscussionGetNext($comments)){
		...
		print "<tr class=\"comments\" id=\"commentrow_".$comments->getID()."\" value=\"" .$comments->getID() ."\"><td>" . $comments->getCreatedDate() . "</td><td>".$comments->getIPNumber()."</td><td></td><td>".substr($comments->getText(), 0, 30)." ...</td></tr>\n"; //MTextGet($content->getTitleTextID())
...
function htmlStart(){
    ...
    print	"<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" .
			...
			"<title>Termos Discussions</title>\n" .
